...
class BookShelvesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create book_shelf" do
    assert_difference("BookShelf.count") do
      post book_shelves_url, params: { book_shelf: { book_id: @book_shelf.book_id, user_id: @book_shelf.user_id } }
    end
  ...
  test "should update book_shelf" do
    patch book_shelf_url(@book_shelf), params: { book_shelf: { book_id: @book_shelf.book_id, user_id: @book_shelf.user_id } }
